...
# General {
	...
	export TMUX_POWERLINE_DIR_USER_THEMES="$DOTFILES/tmux/theme"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/tett23/.mail/inbox/new"

	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/mail/tett23"

	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/tett23/.mailcheckrc"
# }
